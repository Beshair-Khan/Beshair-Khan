...
My expertise includes **Python, SQL, PostgreSQL, Pandas, NumPy, Power BI, and Machine Learning fundamentals**. I specialize in data cleaning, exploratory data analysis (EDA), KPI development, SQL analytics, feature engineering, and building predictive models.

My interests span across **telecom analytics, banking intelligence, FMCG demand forecasting, customer behavior analysis, and SEO analytics**, where I aim to combine analytical thinking with machine learning to create impactful solutions.
...
**Technologies:**
`Python` `Pandas` `SQL` `Machine Learning` `Feature Engineering` `Data Analysis`
